...
https://www.youtube.com/watch?v=vF0M-1OJlWI
...
sum(nm_v+5)
#
sd(nm_v+5) ## CHECK  -- Standard Deviation in much detail 
#
max(nm_v+5)
#
min(nm_v+5)
...
par(mfrow=c(2,1)) # 2 - ROWS , 1 - COLUMN - Filled in by ROWS 
# or we may use - mfcol=c() , to fill by COLUMNS
...
opar <- par(no.readonly=TRUE)
par(mfrow=c(1,2)) # 1 - ROW , 1 - COLUMNS 
...
summary(df_a1)
#
plot(df_a1$a5,df_a1$a6,col=c("red","blue"))
#
